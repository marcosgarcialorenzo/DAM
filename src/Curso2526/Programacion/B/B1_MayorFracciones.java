package Curso2526.Programacion.B;
...
public class B1_MayorFracciones {
    ...
    public static void main(String[] args) {
        Curso2526.Programacion.B.B1_MayorFracciones f1 = new Curso2526.Programacion.B.B1_MayorFracciones(5, 12);
        Curso2526.Programacion.B.B1_MayorFracciones f2 = new Curso2526.Programacion.B.B1_MayorFracciones(2, 4);
        Curso2526.Programacion.B.B1_MayorFracciones fAux;
    ...
    Curso2526.Programacion.B.B1_MayorFracciones multiplicar(Curso2526.Programacion.B.B1_MayorFracciones fraccion) {
        Curso2526.Programacion.B.B1_MayorFracciones resultado = new Curso2526.Programacion.B.B1_MayorFracciones();
        resultado.numerador = this.numerador * fraccion.numerador;
        resultado.denominador = this.denominador * fraccion.denominador;
        return resultado;
    }

    Curso2526.Programacion.B.B1_MayorFracciones dividir(Curso2526.Programacion.B.B1_MayorFracciones fraccion) {
        Curso2526.Programacion.B.B1_MayorFracciones resultado = new Curso2526.Programacion.B.B1_MayorFracciones();
    ...
    Curso2526.Programacion.B.B1_MayorFracciones sumar(Curso2526.Programacion.B.B1_MayorFracciones fraccion) {
        Curso2526.Programacion.B.B1_MayorFracciones resultado = new Curso2526.Programacion.B.B1_MayorFracciones();
    ...
    Curso2526.Programacion.B.B1_MayorFracciones restar(Curso2526.Programacion.B.B1_MayorFracciones fraccion) {
        Curso2526.Programacion.B.B1_MayorFracciones resultado = new Curso2526.Programacion.B.B1_MayorFracciones();
        if (this.denominador == fraccion.denominador) {
            resultado.denominador = this.denominador;
            resultado.numerador = this.numerador - fraccion.numerador;
